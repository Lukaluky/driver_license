        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MvdCheckPassed = table.Column<bool>(type: "boolean", nullable: true),
                    MedicalCheckPassed = table.Column<bool>(type: "boolean", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_Users_InspectorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LicenceCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LicenceCards_Applications_ApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_ApplicantId_Category_Status",
                table: "Applications",
                columns: new[] { "ApplicantId", "Category", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Applications_Iin",
                table: "Applications",
                column: "Iin");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicenceCards_ApplicationId",
                table: "LicenceCards",
                column: "ApplicationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LicenceCards_CardNumber",
                table: "LicenceCards",
                column: "CardNumber",
                unique: true);
